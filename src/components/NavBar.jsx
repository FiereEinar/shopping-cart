...
export default function NavBar({ shoppingItems }) {
  ...
  return (
    <nav id='nav' className='flex justify-between items-center p-2 flex-wrap gap-2 bg-white rounded'>
      <Link className='' to='/shop'><span className='text-4xl'>Logo</span></Link>
